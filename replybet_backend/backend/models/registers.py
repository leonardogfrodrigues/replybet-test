...
class Users(BaseModel):
    name: str = Field (
        title = "User's name",
        description = "User's fullname with a maximum of 70 characters",
        example = "Gertrudes Silva",
        max_length = 70
    )
    phone: str = Field(
        title = "User telephone",
        description = "User's phone with a maximum of 15 characteres",
    ...
    password: str = Field(
        ...
        description = " User's password with a minimum of 8 character and a maximum of 20 characteres",
        example = "F1@gbD412$DD1"
    ) 

    confirmPassword: str = Field(
        title = "User's password confirmation",
        description = " User's password with a minimum of 8 character and maximum of 20 characteres",
        example = "F1@gbD412$DD1"
    ) 
